 ...
 */
let cardLists = ["fa-group", "fa-twitter", "fa-thumbs-o-up", "fa-empire", "fa-wifi", "fa-whatsapp", "fa-youtube", "fa-usd"];
...
function showResults() {
    ...
    timer.pause();
    let scoreBoard = `
              <p class="success">Congratulations,you win!</p>
        <p>
        ...
        <div class="text-center margin-top-2">
             ...
             <div class="star">
                <i class="fa ${ (moves > 19) ? "fa-star-o" : "fa-star"}  fa-3x"></i>    
             </div>
            <div class="star">
      ...
      <button><h2>play Again!</h2></button>
          </div>
    `;
